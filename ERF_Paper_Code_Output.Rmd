...
```{r rfmodelcurves}
# rf_train <- predict(classifier_RF, train, type = "prob")
# rf_test <- predict(classifier_RF, test, type = "prob")
# 
# train.rf <- prediction(`rf_train$Exit Scam`, train$scam_type_grouped)
# test.rf <- prediction(DT.1.pred[, 1], Prediction_Clean$warstds)
# 
# perf.CH <- performance(train.rf, "tpr", "fpr")
# plot(perf.CH, main = "Logistic Regression Vs Decision Tree",
#     col = "#009ECE")
```
